export const EmptyStateIcon = (props) => (
  ...
  >
    <g filter="url(#a)">
      ...
      <path
        fill="#fff"
        d="M161.728 110.204c.951-2.51.858-4.871-.207-5.274-1.064-.404-2.698 1.304-3.649 3.814-.95 2.51-.857 4.871.207 5.274 1.065.404 2.699-1.304 3.649-3.814ZM181.224 113.406c.674-2.598.327-4.935-.776-5.221-1.102-.286-2.541 1.589-3.215 4.186-.673 2.598-.326 4.936.776 5.222 1.102.285 2.542-1.589 3.215-4.187ZM169.357 122.945a.7.7 0 0 1-.683-.552c-.125-.565-.68-2.237-1.561-2.485-.88-.249-2.607.716-3.306 1.222a.7.7 0 1 1-.821-1.134c.276-.199 2.742-1.934 4.507-1.436 1.842.52 2.482 3.228 2.548 3.535a.695.695 0 0 1-.382.781.703.703 0 0 1-.302.069Z"
      />
    </g>
    <defs>
      <filter
